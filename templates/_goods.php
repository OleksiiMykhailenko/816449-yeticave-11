<li class="lots__item lot">
    <div class="lot__image">
        <img src="<?php echo htmlspecialchars($good['image']); ?>" width="350" height="260" alt="">
    </div>
    <div class="lot__info">
        ...
        <div class="lot__state">
            <div class="lot__rate">
                ...
                <span
                    class="lot__cost"><?php echo formatting_sum(htmlspecialchars($good['starting_price'])); ?></span>
            </div>
