<?php
$is_auth = rand(0, 1);
$user_name = 'Oleksii Mykhailenko'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <main class="container">
        ...
        <section class="lots">
            ...
            <ul class="lots__list">
                ...
                <?php
                function formatting_sum(int $sum)
                {
                    $sum = ceil($sum);
                    if ($sum >= 1000) {
                ...
                <?php foreach ($goods as $key => $val): ?>
                    <li class="lots__item lot">
                        <div class="lot__image">
                            <img src="<?php echo $val['url_image']; ?>" width="350" height="260" alt="">
                        </div>
                        <div class="lot__info">
                            ...
                            <div class="lot__state">
                                <div class="lot__rate">
                                    ...
                                    <span
                                        class="lot__cost"><?php echo formatting_sum($val['price']); ?></span>
                                </div>
